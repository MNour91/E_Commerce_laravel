...
<div class="col-md-6 col-sm-6 create-new-account">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group">
		    <label class="info-title" for="password">Password <span>*</span></label>
		    <input type="pa" class="form-control unicase-form-control text-input" id="password"
         ...
         <div class="form-group">
            ...
            type="password" name="password_confirmation" required autocomplete="new-password" class="form-control unicase-form-control text-input" >
