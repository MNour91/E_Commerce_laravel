...
<head>
  <meta charset="utf-8">
    ...
    <title>Nour Ecommerce Admin - Log in </title>
                            ...
                            <form method="POST" action="{{isset($guard) ? url($guard.'/login') : route('login') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password" id="password"
