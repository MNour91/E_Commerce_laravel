...
<section class="content">
        ...
        <div class="row"> <!-- start 8th row  -->
			...
			<div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <textarea id="editor2" name="long_descp_ar" rows="10" cols="80">{{ $products->long_descp_ar }} </textarea>
        ...
        {{-- //////////////////////////start Mulitple Image Update Area ////////////// --}}

        <section class="content">
            <div class="row">
                <div class="box box-outline-info">
                <div class="box-header">
                  <h4 class="box-title">Product Mulitple Image<strong>Update</strong></h4>
                </div>
 ...
 <section class="content">
    <div class="row">
        ...
        <form method="post" action="{{ route('update-product-thmb',$products->id) }}" enctype="multipart/form-data">
            @csrf
                <div class="row row-sm">
